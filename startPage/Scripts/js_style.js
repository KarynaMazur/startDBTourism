function getObj(objID) {
    if (document.getElementById) { return document.getElementById(objID); } else if (document.all) { return document.all[objID]; } else if (document.layers) { return document.layers[objID]; }
}
...
document.write('<tr style="background:rgb(14, 14, 131);font:12px Arial;color:#FFFFFF"><td align=center>Mo</td><td align=center>Tu</td><td align=center>We</td><td align=center>Th</td><td align=center>Fr</td><td align=center>Sa</td><td align=center>Su</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:rgb(159, 241, 196)" onclick="today()">Today: ' + addnull(sccd, sccm + 1, sccy) + '</td></tr>');
...
function cs_over(e) {
    evtTgt(EvtObj(e)).style.background = 'rgb(150, 172, 245)';
}
...
var mn = new Array('January', 'February', 'March', 'April', 'May', 'June', 'July', 'July', 'September', 'October', 'November', 'December');
...
function f_cps(obj) {
    ...
    obj.style.border = '1px solid rgb(14, 14, 131)'; //'1px solid #606060';
...
function f_cpps(obj) {
    ...
    obj.style.font = '10px Arial';
    obj.style.color = '#rgb(14, 14, 131)';
    obj.style.textAlign = 'center';
    obj.style.textDecoration = 'line-through';
    obj.style.border = '1px solid rgb(159, 241, 196)';
    obj.style.cursor = 'default';
}

function f_hds(obj) {
    obj.style.background = 'rgb(159, 241, 196)';
    ...
    for (var d = 1; d <= 42; d++) {
        ...
        if ((d >= (cd - (-1))) && (d <= cd - (-marr[cm]))) {
            ...
            if (sccm == cm && sccd == (d - cd) && sccy == cy)
                cv.style.color = 'rgb(14, 14, 131)';

            // if selected date
            if (cm == selectedm && cy == selectedy && selectedd == (d - cd)) {
                cv.style.background = 'rgb(150, 172, 245)';
